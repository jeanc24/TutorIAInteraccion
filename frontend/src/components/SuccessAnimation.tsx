...
export default function SuccessAnimation({ letter, show, onNext, onRepeat }: SuccessAnimationProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 animate-fade-in">
      <div className="bg-surface-card dark:bg-surface-card-dark rounded-2xl p-8 max-w-sm mx-4 text-center animate-slide-up shadow-xl">
        ...
        <h2 className="text-2xl font-bold mb-1">¡Excelente!</h2>
